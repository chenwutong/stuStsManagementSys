...
<table align="center" width="80%" border="1" style:"margin-top:10px;">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM `student` WHERE `standard`='$standard' AND `name`LIKE '%$name%' ORDER BY `id` ASC";
    ...
    ?>
                <tr align="center">
                    ...
                    <td><a href="updateform.php?id=<?php echo $data['id']; ?>">编辑</a></td>
                </tr>
